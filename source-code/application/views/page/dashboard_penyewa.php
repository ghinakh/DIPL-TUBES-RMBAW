            ...
            <div class="row align-items-center no-gutters">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 mb-lg-0 mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            ...
                            <p class="mb-0">Enjoy a wonderful experiences</p>
                        </div>
                    </div>
                </div>
                <!-- Features -->
                <div class="col-xl-4 col-lg-4 col-md-6 mb-lg-0 mb-4">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            <h4 class="mb-0 font-weight-semi-bold">Affordable Price</h4>
                            <p class="mb-0">We are committed every day to find the best possible deal for your car rental</p>
                        </div>
                    </div>
                </div>
                <!-- Features -->
                <div class="col-xl-4 col-lg-4 col-md-12">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ml-3">
                            <h4 class="mb-0 font-weight-semi-bold">Multi Payment</h4>
                            <p class="mb-0">We provide digital payment and payment on place</p>
                        </div>
                    </div>
                </div>
            </div>

                        ...
                        <div class="modal-dialog modal-dialog-scrollable" role="document">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h3 class="modal-title" id="exampleModalScrollableTitle">Tarik Saldo
                                    </h3>
                                ...
                                <div class="modal-body">
                                    <!-- Form -->
                                    <form class="form-row" method="POST" action="<?= base_url() ?>/Users/tarik_saldo">
                                        <!-- Full name  -->
                                        ...
                                        <!-- Radio -->
                                        <h4 class="form-label col-12 col-md-12 mb-2">Destination</h4>
                                        <!-- Custom control -->
